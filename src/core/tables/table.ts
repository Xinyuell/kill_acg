...
export const ResearchInfoList: Map<number, IResearchInfo> = new Map([
  ...
  [
    EnumResearchItem.ResearchBuildLevel4,
    {
      ...
      UnLock: [EnumResearchItem.BelieverInfluenceMax4,
        EnumResearchItem.BelieverInfluenceMax5,
      ],
      Condition: 0,
    },
  ],
  [
    EnumResearchItem.BelieverInfluenceMax4,
    {
      ...
      Cost1: 200 * 1000 * 1000,
      Cost2: 200 * 1000 * 1000,
      UnLock: [EnumResearchItem.InfluenceMoneyLevel6,
  ...
  [
    EnumResearchItem.InfluenceMoneyLevel6,
    {
      ID: EnumResearchItem.InfluenceMoneyLevel6,
      Name: "思维钢印I",
      Desc: "影响力大幅度提高金钱效率\n影响力额外增加0.05的金钱速度\n消耗500M的动漫知识游戏知识",
      Cost1: 500 * 1000 * 1000,
      Cost2: 500 * 1000 * 1000,
      UnLock: [EnumResearchItem.InfluenceMoneyLevel7],
      Condition: 0,
  ...
  [
    EnumResearchItem.BelieverInfluenceMax5,
    {
      ID: EnumResearchItem.BelieverInfluenceMax5,
      Name: "最终信仰II",
      Desc: "你和你的信徒将付出一生\n每名信徒提高额外1000点影响力上限\n消耗1B的动漫知识游戏知识",
      Cost1: 1000 * 1000 * 1000,
      Cost2: 1000 * 1000 * 1000,
      UnLock: [EnumResearchItem.BelieverInfluenceMax6],
      Condition: 0,
      ResearchProp: new Map([[EnumResearchProp.BelieverAddInfluenceMax, 1000]]),
    },
  ],
  [
    EnumResearchItem.InfluenceMoneyLevel7,
    {
      ID: EnumResearchItem.InfluenceMoneyLevel7,
      Name: "思维钢印II",
      Desc: "影响力大幅度提高金钱效率\n影响力额外增加0.05的金钱速度\n消耗2B的动漫知识游戏知识",
      Cost1: 2*1000 * 1000 * 1000,
      Cost2: 2*1000 * 1000 * 1000,
      UnLock: [EnumResearchItem.InfluenceMoneyLevel8],
      Condition: 0,
      ResearchProp: new Map([[EnumResearchProp.InfluenceMoney, 0.05]]),
    },
  ],
  [
    EnumResearchItem.BelieverInfluenceMax6,
    {
      ID: EnumResearchItem.BelieverInfluenceMax6,
      Name: "最终信仰III",
      Desc: "你和你的信徒将付出一生\n每名信徒提高额外1000点影响力上限\n消耗5B的动漫知识游戏知识",
      Cost1: 5*1000 * 1000 * 1000,
      Cost2: 5*1000 * 1000 * 1000,
      UnLock: [],
      Condition: 0,
      ResearchProp: new Map([[EnumResearchProp.BelieverAddInfluenceMax, 1000]]),
    },
  ...
  [
    EnumResearchItem.InfluenceMoneyLevel8,
    {
      ID: EnumResearchItem.InfluenceMoneyLevel8,
      Name: "思维钢印III",
      Desc: "影响力大幅度提高金钱效率\n影响力额外增加0.05的金钱速度\n消耗10B的动漫知识游戏知识",
      Cost1: 10*1000 * 1000 * 1000,
      Cost2: 10*1000 * 1000 * 1000,
      UnLock: [],
      Condition: 0,
      ResearchProp: new Map([[EnumResearchProp.InfluenceMoney, 0.05]]),
    },
...
export const PolicyInfoList: Map<number, IPolicyInfo> = new Map([
  [
    EnumPolicyItem.ReduceInfluenceBuildCost,
    {
      ...
      Cost: 5 * 1000,
      UpgradeRatio: 6,
      ResearchProp: new Map([[EnumResearchProp.ReduceInfluenceBuildCost, 0.3]]),
      IsReduceProp:true,
    },
  ],
  [
    EnumPolicyItem.ReduceMoneyBuildCost,
    {
      ...
      Cost: 5 * 1000,
      UpgradeRatio: 6,
      ResearchProp: new Map([[EnumResearchProp.ReduceMoneyBuildCost, 0.3]]),
      IsReduceProp:true,
  ...
  [
    EnumPolicyItem.ReduceResearchBuildCost,
    {
      ...
      Cost: 5 * 1000,
      UpgradeRatio: 6,
      ResearchProp: new Map([[EnumResearchProp.ReduceResearchBuildCost, 0.3]]),
      IsReduceProp:true,
    },
  ],
  [
